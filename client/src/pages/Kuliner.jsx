...
import { Search, MapPin, ChevronDown, Menu, X, User, ShoppingBag, HelpCircle } from 'lucide-react';
            ...
            <div className="fixed top-[73px] left-0 right-0 bottom-0 flex">
                ...
                <div className="flex flex-col gap-6 py-4 px-2 bg-white w-20 flex-shrink-0 overflow-y-auto">
                    {categories.map((category) => (
                        ...
                        >
                            <div
                                className={`w-12 h-12 rounded-2xl flex items-center justify-center text-2xl transition-all ${category.id === 'kuliner'
                                    ? 'bg-gradient-to-b from-amber-400 to-white shadow-md'
