...
export default function AtmBanners() {
    ...
    const handleSave = async () => {
        ...
        try {
            const res = await fetch('/api/settings', {
                ...
                body: JSON.stringify({
                    atm_banners: validBanners
                })
            });

            if (res.ok) {
                alert('Banner ATM berhasil disimpan!');
        ...
        <div className="min-h-screen bg-bg flex">
            ...
            <main className="flex-1 ml-64 p-8">
                <header className="flex justify-between items-center mb-8">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-800">Banner ATM & Minimarket</h1>
                        <p className="text-gray-500">Kelola banner horizontal di halaman ATM & Minimarket</p>
                    </div>
                    <button
