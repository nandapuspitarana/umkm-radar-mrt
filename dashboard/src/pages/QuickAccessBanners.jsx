...
function VendorMultiSelect({ value, onChange, vendors }) {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <div
                className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none bg-white cursor-pointer flex justify-between items-center"
                ...
                <div className="absolute z-10 top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden flex flex-col max-h-60">
                    <div className="p-2 border-b border-gray-100 flex-shrink-0">
                        <input
                            ...
                            className="w-full border border-gray-200 rounded px-2 py-1.5 text-xs focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                            value={search}
                    ...
                    <div className="p-2 border-t border-gray-100 bg-gray-50 flex justify-between items-center text-xs">
                        ...
                        <button
                            ...
                            className="bg-blue-100 text-blue-700 hover:bg-blue-200 px-3 py-1.5 rounded font-bold transition-colors"
                        >
                            Selesai
                        </button>
                    </div>
...
const SEED_DATA = [
    {
        ...
        link: '/sub-page/sarapan',
        type: 'medium',
        isDynamicSubpage: true,
        slug: 'sarapan',
        subpageTitle: 'Rekomendasi Sarapan',
        vendorFilter: 'sarapan, nasi uduk, bubur, lontong'
    },
    {
        id: 'qa-2',
        title: 'Butuh Ngopi',
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-xl p-3 space-y-3 mb-3">
                            <div>
                                ...
                                <input
                                    className="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 outline-none"
                                    value={item.slug || ''}
                                    placeholder="Contoh: sarapan, parkir"
                                    onChange={e => {
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="Contoh: Rekomendasi Sarapan"
                                />
                            </div>
                            <div>
