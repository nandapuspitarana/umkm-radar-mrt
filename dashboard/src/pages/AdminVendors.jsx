...
export default function AdminVendors() {
    ...
    const downloadTemplate = () => {
        const template = [{
            name: "Contoh", description: "Deskripsi", category: "kuliner", subcategory: "Makanan",
        ...
        XLSX.writeFile(wb, "template_vendors.xlsx");
    };
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4" noValidate>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        id="subcategory" data-testid="input-subcategory"
                                        ...
                                        onChange={e => setVendorField('subcategory', e.target.value)}
                                        placeholder="Contoh: Nasi & Lontong"
                                    />
                                </div>
